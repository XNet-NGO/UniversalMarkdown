...
public class TableRowSpan extends ReplacementSpan {
    ...
    private TableScrollState scrollState;
    ...
    /**
     * Update the current maximum row count
    ...
    public void draw(
        ...
        // If this is the header, shift down by height to reserve space for the top block drawing
    ...
    public void setScrollState(TableScrollState state) {
        this.scrollState = state;
    }

    public TableScrollState getScrollState() {
        return scrollState;
    }
