...
public class DrawableWrapper {
    ...
    public void onLoadSuccess(Drawable drawable) {
        ...
        } catch (Throwable e) { // local package: java.lang.NoClassDefFoundError: Failed resolution of: Landroid/support/v4/graphics/drawable/RoundedBitmapDrawableFactory; handle compatibility
            MDLogger.e(TAG, e);
            mDrawable = drawable;
        }
